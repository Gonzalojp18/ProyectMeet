...
export const defaultStyles = {
    ...
    title: "text-4xl font-extrabold mb-8 olive-title text-left text-orange-700",
    subtitle: "text-xl text-left text-gray-500 mb-2",
    grid: "grid md:grid-cols-2 gap-2",
    item: "rounded-xs shadow-xs flex justify-between border-b-1 border-gray-400 p-1 bg-gray-100",
...
export const compactStyles = {
    ...
    title: "text-4xl font-bold mb-8 text-left text-white",
...
export const featuredStyles = {
    ...
    title: "text-4xl font-extrabold text-left text-yellow-500",
